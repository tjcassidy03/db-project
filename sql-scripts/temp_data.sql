...
VALUES ('al_1', 'Echoes of Tomorrow', 'http://example.com/al1.jpg', '1990-01-01', 15, 152),
  ('al_2', 'Midnight Reflections', 'http://example.com/al2.jpg', '1991-02-02', 16, 53),
  ('al_3', 'Celestial Journeys', 'http://example.com/al3.jpg', '1992-03-03', 17, 47),
  ('al_4', 'Whispers in the Wind', 'http://example.com/al4.jpg', '1993-04-04', 18, 27),
  ('al_5', 'Urban Serenade', 'http://example.com/al5.jpg', '1994-05-05', 15, 56),
  ('al_6', 'Faded Dreams', 'http://example.com/al6.jpg', '1995-06-06', 16, 48),
  ('al_7', 'Shadows and Light', 'http://example.com/al7.jpg', '1996-07-07', 17, 285),
  ('al_8', 'Heartbeat Symphony', 'http://example.com/al8.jpg', '1997-08-08', 18, 342),
  ('al_9', 'Timeless Horizons', 'http://example.com/al9.jpg', '1998-09-09', 15, 887),
  ('al_10', 'Lost in Translation', 'http://example.com/al10.jpg', '1999-10-10', 16, 987),
  ('al_11', 'Wanderlust Melodies', 'http://example.com/al11.jpg', '2000-11-11', 17, 566),
  ('al_12', 'Secrets of the Sea', 'http://example.com/al12.jpg', '2001-12-12', 18, 465),
  ('al_13', 'Kaleidoscope Visions', 'http://example.com/al13.jpg', '2002-01-13', 15, 902),
  ('al_14', 'Electric Daydreams', 'http://example.com/al14.jpg', '2003-02-14', 16, 327),
  ('al_15', 'Portraits of Emotion', 'http://example.com/al15.jpg', '2004-03-15', 17, 542),
  ('al_16', 'Rhythm of the Night', 'http://example.com/al16.jpg', '2007-04-16', 18, 633),
  ('al_17', 'Through the Looking Glass', 'http://example.com/al17.jpg', '2008-05-17', 15, 142),
  ('al_18', 'Fragments of Time', 'http://example.com/al18.jpg', '2009-06-18', 16, 987),
  ('al_19', 'Nature’s Canvas', 'http://example.com/al19.jpg', '2010-07-19', 17, 213),
  ('al_20', 'Unwritten Chapters', 'http://example.com/al20.jpg', '2011-08-20', 18, 243),
  ('al_21', 'Celestial Echoes', 'http://example.com/al21.jpg', '2012-09-21', 15, 534),
  ('al_22', 'The Color of Sound', 'http://example.com/al22.jpg', '2013-10-22', 16, 765),
  ('al_23', 'Resonance of Souls', 'http://example.com/al23.jpg', '2014-11-23', 17, 124),
  ('al_24', 'Untamed Spirit', 'http://example.com/al24.jpg', '2015-12-24', 18, 908),
  ('al_25', 'Reflections of a Dreamer', 'http://example.com/al25.jpg', '2016-01-25', 15, 782),
  ('al_26', 'Harmony in Chaos', 'http://example.com/al26.jpg', '2017-02-26', 16, 531),
  ('al_27', 'A Journey Within', 'http://example.com/al27.jpg', '2018-03-27', 17, 382),
  ('al_28', 'Between the Lines', 'http://example.com/al28.jpg', '2019-04-28', 18, 324),
  ('al_29', 'Vintage Vibes', 'http://example.com/al29.jpg', '2022-05-29', 15, 490),
  ('al_30', 'The Art of Stillness', 'http://example.com/al30.jpg', '2024-06-30', 16, 538);
